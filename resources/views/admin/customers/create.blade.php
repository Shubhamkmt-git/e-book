...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="space-y-1">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight font-roboto">Add Customer</h1>
            <p class="text-xs sm:text-sm text-slate-500">Create a new customer account for the platform.</p>
        </div>
    ...
    <form id="customer-form" action="{{ route('admin.customers.store') }}" method="POST" class="space-y-5" novalidate>
        @csrf
        ...
        <div class="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-2xs space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Mobile --}}
                <div class="space-y-1.5">
                    <label for="mobile" class="block text-xs font-bold uppercase tracking-wider text-slate-700">
                        Mobile Number
                    </label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
        ...
        <div class="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-2xs space-y-6">
            <div class="flex items-center gap-2.5 pb-4 border-b border-slate-100">
                ...
                <h2 class="text-sm font-bold text-slate-800">Set Password</h2>
            </div>
        ...
        <div class="flex items-center justify-end gap-3 pt-1">
            ...
            <button type="submit"
                ...
                <i class="fa-solid fa-user-plus text-xs"></i> Create Customer
            </button>
        </div>
