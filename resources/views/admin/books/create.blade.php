...
@section('title', 'Add E-Book (Multi-Step)')
...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="space-y-1">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight font-roboto">Add E-Book</h1>
            <p class="text-xs sm:text-sm text-slate-500">Create a comprehensive e-book entry in 5 organized steps.</p>
        </div>
            ...
            <div class="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-2xs space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <p class="text-[11px] text-slate-400 flex items-center gap-1.5"><i class="fa-solid fa-link text-[10px] text-brand-500"></i> The URL slug is automatically generated from this title.</p>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="price" id="price" value="{{ old('price', '499.00') }}" required
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="selling_price" id="selling_price" value="{{ old('selling_price', '299.00') }}" required
                                oninput="calculateDiscount()"
                ...
                <div class="pt-4 border-t border-slate-100 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="number" name="pages" id="pages" value="{{ old('pages', '368') }}" placeholder="e.g. 368"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="language" id="language" value="{{ old('language', 'English') }}" placeholder="e.g. English"
                                class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 focus:bg-white text-slate-900 text-sm border border-slate-200 focus:border-brand-500 focus:outline-none transition font-medium">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="format" id="format" value="{{ old('format', 'PDF, EPUB') }}" placeholder="e.g. PDF, EPUB"
                                class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 focus:bg-white text-slate-900 text-sm border border-slate-200 focus:border-brand-500 focus:outline-none transition font-medium">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="file_size" id="file_size" value="{{ old('file_size', '14.1 MB') }}" placeholder="e.g. 14.1 MB"
                                class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 focus:bg-white text-slate-900 text-sm border border-slate-200 focus:border-brand-500 focus:outline-none transition font-medium">
...
Chapter 5: Production Case Studies & Bottleneck Hunting"
                    ...
                    >{{ old('table_of_contents') }}</textarea>
            ...
            <div class="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-2xs space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-3 p-5 rounded-2xl bg-slate-50 border border-slate-200/90 flex flex-col justify-between">
                        ...
                        <div id="cover-preview-container" class="hidden relative rounded-xl overflow-hidden border border-slate-200 bg-white aspect-3/4 max-w-[170px] mx-auto shadow-sm group">
                        ...
                        <div id="cover-dropzone" class="border-2 border-dashed border-slate-300 hover:border-purple-400 bg-white rounded-xl p-5 text-center transition cursor-pointer" onclick="document.getElementById('cover_image').click()">
                    ...
                    <div class="space-y-3 p-5 rounded-2xl bg-slate-50 border border-slate-200/90 flex flex-col justify-between">
                        ...
                        <div id="sample-preview-box" class="hidden p-3 rounded-xl bg-sky-50 border border-sky-200 text-xs text-sky-800 flex items-center justify-between">
                            <div class="flex items-center gap-2 truncate">
                                <i class="fa-solid fa-file-pdf text-sky-600 text-base shrink-0"></i>
                                <span id="sample-filename" class="font-semibold truncate">sample.pdf</span>
                            </div>
                        ...
                        <div id="sample-dropzone" class="border-2 border-dashed border-slate-300 hover:border-sky-400 bg-white rounded-xl p-5 text-center transition cursor-pointer" onclick="document.getElementById('sample_file').click()">
                    ...
                    <div class="space-y-3 p-5 rounded-2xl bg-slate-50 border border-slate-200/90 flex flex-col justify-between">
                        ...
                        <div id="ebook-preview-box" class="hidden p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-xs text-emerald-800 flex items-center justify-between">
                            <div class="flex items-center gap-2 truncate">
                                <i class="fa-solid fa-file-shield text-emerald-600 text-base shrink-0"></i>
                                <span id="ebook-filename" class="font-semibold truncate">ebook.pdf</span>
                            </div>
                        ...
                        <div id="ebook-dropzone" class="border-2 border-dashed border-slate-300 hover:border-emerald-400 bg-white rounded-xl p-5 text-center transition cursor-pointer" onclick="document.getElementById('ebook_file').click()">
        ...
        <div id="step-content-5" class="step-content hidden space-y-6">
            <div class="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-2xs space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    @php 
                        $oldSuggested = (array) old('suggested_for', []); 
                        $presetTitles = array_column($suggestedAudiences, 'title');
                        
                        // Extract old suggested titles (handling ::: icon separator or plain strings)
                        $oldSuggestedTitles = array_map(function($item) {
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                        ...
                        <label class="flex items-center gap-3 p-3 rounded-xl border border-slate-200 hover:border-brand-300 hover:bg-brand-50/30 transition cursor-pointer select-none group">
                            <input type="checkbox" name="suggested_for[]" value="{{ $audience['title'] }}"
                                {{ in_array($audience['title'], $oldSuggestedTitles) ? 'checked' : '' }}
                ...
                <div class="pt-6 border-t border-slate-100 space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" placeholder="e.g. Masterclass in Scalable Distributed Architecture | E-Book"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="e.g. system design, distributed systems, architecture, algorithms, coding"
                            class="w-full px-4 py-2.5 rounded-xl bg-slate-50 focus:bg-white text-slate-900 text-sm border border-slate-200 focus:border-brand-500 focus:outline-none transition font-medium">
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <button type="submit" class="px-7 py-3 rounded-xl bg-brand-600 hover:bg-brand-700 active:bg-brand-800 text-white text-xs sm:text-sm font-bold shadow-md transition flex items-center gap-2 cursor-pointer">
                    ...
                    <span>Complete & Publish E-Book</span>
                </button>
            </div>
        </div>
...
<script>
    ...
    function previewEbookFile(input) {
        if (input.files && input.files[0]) {
            ...
            if (sizeInput && (!sizeInput.value || sizeInput.value === '14.1 MB')) {
