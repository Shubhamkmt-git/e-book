...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="space-y-1">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight font-roboto">Add Hero Banner</h1>
            <p class="text-xs sm:text-sm text-slate-500">Create a new homepage hero banner with image, title, and CTA buttons.</p>
        </div>
    ...
    <form id="banner-form" action="{{ route('admin.hero-banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" novalidate>
        @csrf
            ...
            <div class="xl:col-span-2 space-y-5">
                ...
                <div class="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-4">
                    ...
                    <div id="image-drop-zone"
                        ...
                        <div id="image-placeholder" class="flex flex-col items-center gap-3 py-8 px-6 text-center">
                    ...
                    <button type="button" id="remove-img-btn" onclick="removeImage()"
                            class="hidden text-xs text-rose-600 hover:text-rose-700 font-semibold flex items-center gap-1 transition">
                ...
                <div class="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required
                            placeholder="e.g. Discover Amazing E-Books"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="title_l2" id="title_l2" value="{{ old('title_l2') }}"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="description" id="description" rows="3"
                            placeholder="A short compelling subtitle shown beneath the banner title…"
                            class="w-full px-3.5 py-3 rounded-xl bg-slate-50 focus:bg-white text-slate-900 placeholder-slate-400 text-sm border border-slate-200 focus:border-brand-500 focus:outline-none transition font-medium resize-none">{{ old('description') }}</textarea>
                ...
                <div class="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="primary_button" id="primary_button" value="{{ old('primary_button') }}"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="primary_button_link" id="primary_button_link" value="{{ old('primary_button_link') }}"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="secondary_button" id="secondary_button" value="{{ old('secondary_button') }}"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="secondary_button_link" id="secondary_button_link" value="{{ old('secondary_button_link') }}"
            ...
            <div class="space-y-5 sticky top-6 self-start">
                ...
                <div class="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-3">
                    ...
                    <button type="submit" form="banner-form"
                        ...
                        <i class="fa-solid fa-floppy-disk text-xs"></i> Create Banner
                    </button>
                    <a href="{{ route('admin.hero-banners.index') }}"
