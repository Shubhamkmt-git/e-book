...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="space-y-1">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight font-roboto">Add FAQ</h1>
            <p class="text-xs sm:text-sm text-slate-500">Create a new frequently asked question.</p>
        </div>
    ...
    <form id="faq-form" action="{{ route('admin.faqs.store') }}" method="POST" class="space-y-5" novalidate>
        @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="answer" id="answer" rows="4" required
                        ...
                        class="w-full px-4 py-3 rounded-xl bg-slate-50 focus:bg-white text-slate-900 placeholder-slate-400 text-sm border border-slate-200 focus:border-brand-500 focus:outline-none transition font-medium resize-y @error('answer') border-rose-300 bg-rose-50/50 @enderror">{{ old('answer') }}</textarea>
        ...
        <div class="flex items-center justify-end gap-3 pt-1">
            ...
            <button type="submit"
                ...
                <i class="fa-solid fa-plus text-xs"></i> Create FAQ
            </button>
        </div>
