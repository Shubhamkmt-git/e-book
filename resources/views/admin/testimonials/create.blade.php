...
<div class="w-full space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="space-y-1">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight font-roboto">Add Testimonial</h1>
        </div>
    ...
    <form id="testimonial-form" action="{{ route('admin.testimonials.store') }}" method="POST" class="space-y-6" novalidate>
        @csrf
                ...
                <div class="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="message" id="message" rows="4" required
                            placeholder="What did this person say about your platform?"
                            class="w-full px-3.5 py-3 rounded-xl bg-slate-50 focus:bg-white text-slate-900 placeholder-slate-400 text-sm border border-slate-200 focus:border-brand-500 focus:outline-none transition font-medium resize-none @error('message') border-rose-300 bg-rose-50/50 @enderror">{{ old('message') }}</textarea>
            ...
            <div class="space-y-5 sticky top-6 self-start">
                ...
                <div class="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-3">
                    ...
                    <button type="submit" form="testimonial-form"
                        ...
                        <i class="fa-solid fa-floppy-disk text-xs"></i> Save Testimonial
                    </button>
                    <a href="{{ route('admin.testimonials.index') }}"
                ...
                <div class="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        @error('rating')<p class="text-xs text-rose-600 font-medium">{{ $message }}</p>@enderror
                    </div>
